...
def fill_profile(jobtypes1, jobtypes2, sizes, folder):
    execution_time = init_prof(jobtypes1, jobtypes2, sizes)
    ...
    with open(name) as f:
        for line in f:
            ...
            if "collocation" in l[0]:
                job_type1 = str(l[2])
                num_gpus1 = len(str(l[4]).split(","))
                size1 = str(l[6])
                job_type2 = str(l[8])
                num_gpus2 = len(str(l[10]).split(","))
...
if __name__ == '__main__':
    ...
    for folder in folders:
        execution_time = fill_profile(caffe_types1, caffe_types2, sizes, folder)
